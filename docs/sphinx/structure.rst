...
Be 3% smarter than your average bear.
...
Accept or reject incoming :class:`DataPoints <ampel.content.DataPoint.DataPoint>`.

Tier 1: Augment
###############

Augment newly created :class:`DataPoints <ampel.content.DataPoint.DataPoint>`, or create new ones.

.. warning:: This may not be what T1 actually does
...
Produce a summary of objects currently tracked by a set of channels, and perform some action with it.
