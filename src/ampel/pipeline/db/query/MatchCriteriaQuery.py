#!/usr/bin/env python
# -*- coding: utf-8 -*-
# File              : ampel/pipeline/db/query/MatchCriteriaQuery.py
...
class MatchCriteriaQuery:
	"""
	"""


	@staticmethod
	def add_match_from_list(inlist, query, field_name, should_type=str):
		"""
	...
	@staticmethod
	def add_nomatch_from_list(inlist, query, field_name, should_type=str):
		"""
		ATTENTION: call this method *last* if you want to combine 
		the match criteria generated by this method with the one 
		computed in method add_match_from_list

		Parameters: see docstring of add_match_from_list
