...
class ChannelsConfig:
	...
	def get_channel_flag_label(self, channel_name):
		"""	
		...
		return self.config[channel_name]['flagLabel']


	def get_filter_config(self, channel_name):
		"""	
			Dict path lookup shortcut function
		"""	
		if channel_name not in self.config:
	...
	def get_channel_flag(self, channel_name):
		"""	
		...
		flag = ChannelFlags[self.config[channel_name]['flagLabel']]
	...
	def get_t2_module_param(self, channel_name, module_name):
		"""	
			Dict path lookup shortcut function
		"""	
		if channel_name not in self.config:
