...
class LogsLoader:
	...
	def fetch_main_logs(
		...
		:param List[str] remove: possible values: 'channels', '_id', 'tranId'
		"""
		...
		if decompactify:
			...
			# Converts
			#  {'_id': ObjectId('5c80d71154048002ca372208'),
  			#  'tranId': 1810112413252531,
  			#  'alertId': 697252385515010002,
  			#  'flag': 8740,
  			#  'runId': 714,
  			#  'msg': {'channels': 3, 'txt': 'test2'},
			...
			# log entries associated with other channels
			if hasattr(matcher, 'channels'):
				stages.append(
					{
						'$match': {
